...
通知客户端，支持请求资源的所有http方法，当服务器接收到不支持的请求方法的时候会返回405 Method Not Allowed，与此同时，还会把所有支持的方法写入响应报文的首部字段Allow字段返回

### Content-Encoding

告知客户端，服务器对实体的主体部分选用的内容编码方式： Content-Encoding: gzip
...
表明实体主体部分的大小，单位是字节，对实体的主体进行内容编码的时候，不再使用该字段
...
一串由MD5算法生成的值，目的在于检查报文主体在传输过程中是否完整

### Content-Range

针对范围请求，响应的Content-Range字段告知客户端，响应返回的实体中哪个部分符合范围

Content-Range： bytes 5001-10000 / 10000

5001-10000 符合范围请求的部分，
/10000 整个实体大小
